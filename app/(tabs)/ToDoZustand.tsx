...
export default function ToDoZustand() {
    ...
    const {todos, setToDo, addToDo, updateToDo, deleteToDo, toggleToDoComplete } = Todo();
    useEffect(() => {
        ...
        const fetchTodos = async () => {
            try {
                ...
                if (user) {
                    ...
                    setToDo([])// If no user, set todos to empty array
                }
            } catch (err) {
    ...
    const addTodo = async (values) => {
        ...
        try {
            ...
            if (user) {
                ...
                addToDo({...values, id: data._documentPath._parts[1]})
                // console.log(todos);
    ...
    const editTodo = async (values) => {
        ...
        try {
            if (todoToEdit) {
                ...
                updateToDo(todoToEdit.id, values)
            }
        } catch (err) {
